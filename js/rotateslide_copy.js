//rotating-slider.js
//https://codepen.io/zenasen/pen/YbZjKL
...
$(function() {
  $(".rotating-slider").rotatingSlider({
    //slideHeight: Math.min(480, window.innerWidth - 80),
    //slideWidth: Math.min(960, window.innerWidth - 80),
    autoRotate: false,
    afterRotationStart: function() {
      console.log(
